...
const Menu: React.FC = () => {
  ...
  return (
    <main className="relative h-screen w-screen bg-[url('../assets/images/background_menu.png')] bg-cover bg-center">
      <section className="flex items-center justify-center h-full">
        <article className="p-8 flex flex-col justify-center bg-[#19181F] bg-opacity-90 border border-[#1E1E26] rounded-lg shadow-2xl w-[40rem]">
          ...
          <div className="bg-green-600 text-white text-sm font-semibold px-4 py-2 rounded-full mb-8 w-fit">Recommended if you are new to TM</div>
      ...
      <section className="absolute bottom-6 left-0 right-0 flex justify-center gap-6">
        ...
        border border-[#19181F] bg-[#1E1E26] hover:bg-[#67159C] rounded-lg p-5 px-6">
        ...
        border border-[#19181F] bg-[#1E1E26] hover:bg-[#67159C] rounded-lg px-6"><DoorOpen className="w-6 h-6" /> Exit</AlertDialogTrigger>
          <AlertDialogContent className="bg-[#19181F] border-zinc-800">
            ...
            <AlertDialogFooter>
              ...
              <AlertDialogAction 
                onClick={handleExit}
                className="w-32 cursor-pointer text-white bg-[#1E1E26] border border-zinc-800 hover:bg-[#67159C]">
                  <LogOut /> Exit
              </AlertDialogAction>
            </AlertDialogFooter>
          </AlertDialogContent>
